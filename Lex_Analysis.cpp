...
vector<pair<const char *,int> > keyMap;				//关键字二元组表
vector<pair<const char *,int> > operMap;			//运算符二元组表
vector<pair<const char *,int> > limitMap;			//界符二元组表
...
{  
    ...
    keyMap.push_back(make_pair("kind",DESCRIBE));  
    keyMap.push_back(make_pair("type",TYPE));  
    keyMap.push_back(make_pair("string",STRING));  
    keyMap.push_back(make_pair("number",DIGIT));  
...
{  
    ...
    p = p->next;  
    cout<<"\n词法分析结果："<<endl<<endl;  
    cout << setw(10) <<"词语"<<setw(10)<<"词别"<<"\t"<<"syn"<<endl;
    while(p!=NULL)  
    {   
        cout<< setw(10)<<p->content<<setw(10)<<p->kind<<"\t"<<p->type<<endl;
        p = p->next;  
    }  
    cout<<endl<<endl;  
}  
...
{  
    ...
    while(p!=NULL)  
    {  
        cout<<setw(10)<<p->content<<setw(30)<<p->kind<<"\t"<<p->type<<"\t"<<p->line<<endl;  
        p = p->next;  
    }  
    cout<<endl<<endl;  
	*/
...
{  
    ...
    while(p!=NULL)  
    {  
        cout<<setw(30)<<p->content<<setw(10)<<p->kind<<"\t"<<p->type<<"\t"<<p->addr<<"\t"<<p->line<<endl;  
        p = p->next;  
    }  
    cout<<endl<<endl;  
	*/
